        ...
        <div className="flex flex-row h-full w-full overflow-x-hidden">
          <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
            ...
            <div className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
              ...
              <div className="text-sm font-semibold mt-2">Abel Mbula</div>
              <div className="text-xs text-gray-500">Coach developer</div>
              <div className="flex flex-row items-center mt-3">
                <div className="flex flex-col justify-center h-4 w-8 bg-indigo-500 rounded-full">
                  <div className="h-3 w-3 bg-white rounded-full self-end mr-1"></div>
                </div>
                <div className="leading-none ml-1 text-xs">En ligne</div>
              </div>
            </div>
            <div className="flex flex-col mt-8">
              ...
              <div className="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                  ...
                  <div className="ml-2 text-sm font-semibold">Bonheur Bushiri</div>
                </button>
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                  <div className="flex items-center justify-center h-8 w-8 bg-gray-200 rounded-full">
                    M
                  </div>
                  <div className="ml-2 text-sm font-semibold">Gloire M.</div>
                  <div
                ...
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                  ...
                  <div className="ml-2 text-sm font-semibold">Valnas</div>
                </button>
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                ...
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                  ...
                  <div className="ml-2 text-sm font-semibold">Cedric K.</div>
                </button>
              </div>
              <div className="flex flex-row items-center justify-between text-xs mt-6">
                <span className="font-bold">Archivés</span>
              ...
              <div className="flex flex-col space-y-1 mt-4 -mx-2">
                <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                  ...
                  <div className="ml-2 text-sm font-semibold">Josh Makuta</div>
                </button>
              </div>
            </div>
          </div>
